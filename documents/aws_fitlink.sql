...
('등', '펜들레이 로우'), ('등', '인클라인 바벨 로우'), ('등', '정지 바벨 로우'), ('등', '원암 하이 로우 머신'),
-- 어깨
...
('어깨', '슈러그 그 머신'), ('어깨', '아놀드 덤벨 프레스'), ('어깨', '리어 델토이드 플라이 머신'), ('어깨', '케이블 슈러그'),
...
('어깨', '시티드 덤벨 리어 레터럴 레이즈'), ('어깨', '핸드스탠드'), ('어깨', '숄더 탭'),
-- 하체
('하체', '컨벤셔널 데드리프트'), ('하체', '리버스 보수 스쿼트'), ('하체', '파워 레그 프레스'), ('하체', '바벨 백스쿼트'),
('하체', '글루트 킥백 머신'), ('하체', '사이드 레그 클램'), ('하체', '스미스머신 스플릿 스쿼트'), ('하체', '힙 어브덕션 머신'),
('하체', '덤벨 원레그 데드리프트'), ('하체', '스미스머신 데드리프트'), ('하체', '시티드 레그 컬'), ('하체', '덤벨 와이드 스쿼트'),
('하체', '스미스머신 스쿼트'), ('하체', '정지 팩 스쿼트'), ('하체', '케틀벨 스모 데드리프트'), ('하체', '덤벨 런지'),
...
('하체', '영키 킥'), ('하체', '스탠딩 카프 레이즈'), ('하체', '시티드 레그 림'), ('하체', '케이블 덩키 킥'), ('하체', '이너 싸이 머신'),
('하체', '힙 쓰러스트 머신'), ('하체', '데피싯 데드리프트'), ('하체', '런지'), ('하체', '맨몸 카프 레이즈'), ('하체', '안트 워크'),
('하체', '스텝업'), ('하체', '글루트 브릿지'), ('하체', '케틀벨 런지 트위스트'), ('하체', '중량 스텝업'),
('하체', '덤벨 루마니안 데드리프트'), ('하체', '케이블 풀 스루'), ('하체', '힙 쓰러스트'), ('하체', '과일 힙 어브덕션'),
('하체', '몬스터 글루트 머신'), ('하체', '바벨 힙 쓰러스트'), ('하체', '싱글 레그 글루트 브릿지'), ('하체', '브이 스쿼트'),
-- 팔
...
('역도', '중량 행잉 니 레이즈'), ('역도', '저크'), ('역도', '케틀벨 스내치'), ('역도', '클린 하이풀'), ('역도', '스내치'),
